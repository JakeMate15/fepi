...
\newcommand{\mysubtitle}%
	{Alcance en proyectos de software}

\newcommand{\myauthor}%
	{Morales López Erik}

\newcommand{\myemail}%
	{\href{mailto:emoralesl1700@alumno.ipn.mx}%
	{\texttt{emoralesl1700@alumno.ipn.mx}}}%
...
% Ocultar numeración en títulos (se mantiene en el índice)
